...
SCENARIOS: List[Scenario] = [
    Scenario(
        ...
        # 시나리오 설명
        setup="한 병원이 새로운 의료 AI 진단 시스템 MedAI 도입을 검토하고 있다.시뮬레이션 결과 MedAI 도입 시 기존 대기 시간 때문에 치료받지 못해 사망하던 
환자 1,000명을 살릴 수 있지만, AI의 한계로 약 50명은 잘못된 진단을 받을 수 있다. AI 의료 진단 시스템을 도입할 것인가?"
